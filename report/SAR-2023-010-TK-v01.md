...
The average change in CAL was slightly higher in the Gel 40 group when compared to Gen-Os group, but its distribution appears to be bi-modal, although its shape seems more well-defined with less variability around the center.
This bi-modality could be a result of the larger amount of participants in the lower range of REC change when compared to the Gen-Os group.
