---
title: "Analytical Plan for Efficacy of pre-hydrated collagenated xenogenic bone mix in periodontal intrabony defects: clinical trial"
...
**Analytical Plan for Efficacy of pre-hydrated collagenated xenogenic bone mix in periodontal intrabony defects: clinical trial**
...
- The REC change from baseline is different in both biomaterials;
- The CAL change from baseline is different in both biomaterials;
- The PD change from baseline is different in both biomaterials;
- The CAL change from baseline is different in both biomaterials;
- The TP change from baseline is different in both biomaterials.
...
Pre-hydrated collagenated xenogenic bone mix (0-Gel40) or bone graft (1-Gen-Os).
...
Outcomes will be compared between exposure groups with the
...
The Cohen's d standardized mean difference will be reported for all outcomes as the effect size for the efficacy of the main exposure relative to the gold standard.
...
This is considered a large effect size, which means that this study is only powered to detect large differences in outcomes.
...
<!-- - **SAR-2023-010-TK-v01** -- Efficacy of pre-hydrated collagenated xenogenic bone mix in periodontal intrabony defects: clinical trial -->
